...
function select_load(obeto,array,tipo,event){
//alert(obeto.childNodes.length)

    if(obeto.childNodes.length==1){   
       // alert("si")
        array.forEach(element => {
          
            if(tipo==1){  obeto.innerHTML+="<option>"+element+"</option>"
            }else{        obeto.innerHTML+="<option>"+element.tagName+"</option>"
            }
        });
